...
if __name__ == '__main__':
    ...
    input_size = num_inputs * np.prod(input_shape) ##product
    weight_size = output_dim * np.prod(input_shape)


    ##-------------------------------Test forward funciton: pass!------------------------------
    ...
    #
    # std = 1e-3
    # model = TwoLayerNet_v2(input_dim=D, hidden_dim=H, num_classes=C,
    #                        weight_scale=std, reg=0.0)
    ...
    ##--------------------------------Use solver class to train: pass!----------------------------------
    # solver_data = {}
    ...
    #                 optim_config={'learning_rate': 5e-4}, lr_decay=0.9,
    ...
    #
    # plt.plot(solver.loss_history, 'o')
    # plt.title('Trainig loss history')
    # plt.xlabel('Iteration')
    ...
    batch_size, D, H1, H2, H3, H4, C = 100, X_train.shape[1], 100, 100, 100, 100, 10
    net = FullyConnectedNet([H1, H2, H3, H4], input_dim=D, num_classes=C,
                            dropout=0.95, normalization='batchnorm', reg=0.95, weight_scale=weight_scale,
